...
namespace Mediapipe.UnityRunner.PoseLandmarkDetection
{
    ...
    {
        [SerializeField] private PoseLandmarkerResultController _poseLandmarkerResultController;
        ...
        protected override IEnumerator Run()
        {
            ...
            SetupAnnotationController(_poseLandmarkerResultController, imageSource);
            _poseLandmarkerResultController.InitScreen(imageSource.textureWidth, imageSource.textureHeight);
            ...
            while (true)
            {
                ...
                switch (taskApi.runningMode)
                {
                    case Tasks.Vision.Core.RunningMode.IMAGE:
                        ...
                        {
                            _poseLandmarkerResultController.DrawNow(result);
                        }
                        else
                        {
                            _poseLandmarkerResultController.DrawNow(default);
                        }
        ...
        {
            _poseLandmarkerResultController.DrawLater(result);
            DisposeAllMasks(result);
        }
